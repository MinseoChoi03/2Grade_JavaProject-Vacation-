...
public class CongPanel extends JPanel{
	...
	public CongPanel() {
		...
		flower1.setIcon(new ImageIcon(getClass().getResource("../flower/bouquet3.png")));
		flower1.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower1.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/bouquet3E.png")));
		...
		flower2.setIcon(new ImageIcon(getClass().getResource("../flower/bouquet4.png")));
		flower2.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower2.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/bouquet4E.png")));
		...
		flower3.setIcon(new ImageIcon(getClass().getResource("../flower/pampas_grass.png")));
		flower3.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower3.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/pampas_grassE.png")));
		...
		flower4.setIcon(new ImageIcon(getClass().getResource("../flower/mum.png")));
		flower4.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower4.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/mumE.png")));
		...
		flower5.setIcon(new ImageIcon(getClass().getResource("../flower/sunflower.png")));
		flower5.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower5.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/sunflowerE.png")));
