...
public class LovePanel extends JPanel {
	...
	public LovePanel() {
		...
		flower1.setIcon(new ImageIcon(getClass().getResource("../flower/bouquet5.png")));
		flower1.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower1.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/bouquet5E.png")));
		...
		flower2.setIcon(new ImageIcon(getClass().getResource("../flower/bouquet6.png")));
		flower2.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower2.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/bouquet6E.png")));
		...
		flower3.setIcon(new ImageIcon(getClass().getResource("../flower/peony.png")));
		flower3.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower3.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/peonyE.png")));
		...
		flower4.setIcon(new ImageIcon(getClass().getResource("../flower/lisianthus.png")));
		flower4.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower4.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/lisianthusE.png")));
		...
		flower5.setIcon(new ImageIcon(getClass().getResource("../flower/rose.png")));
		flower5.addMouseListener((MouseListener) new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				flower5.setIcon(new ImageIcon(getClass().getResource("../flowerBtn/roseE.png")));
